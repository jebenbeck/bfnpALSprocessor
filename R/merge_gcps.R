...
#' @param gcp_data_test object of class `spatial points` as generated by `prepare_gcps())`.
#' This is the dataset the accurracy should be checked for
#' @param gcp_data_ref object of class `spatial points` as generated by `prepare_gcps())`.
